...
export const router = createBrowserRouter([
  ...
  { path: "/hiring/jobs/new", element: <Protected><CreateJobPage /></Protected> },
  ...
  { path: "/candidates/new", element: <Navigate replace to="/hiring/candidates/new" /> },
  { path: "/hiring/candidates/new", element: <Protected><CreateCandidatePage /></Protected> },
  ...
  { path: "/approvals", element: <Protected><ApprovalsPage /></Protected> },
