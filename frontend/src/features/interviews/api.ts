...
export const updateStage = (org: string, id: string, body: { name?: string; description?: string | null; duration_minutes?: number }) => apiClient<{ stage: Stage }>(`${base(org)}/interview-stages/${id}`, { method: "PATCH", body: JSON.stringify(body) });
